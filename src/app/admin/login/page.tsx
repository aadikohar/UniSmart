        ...
        <div className="bg-surface-container-highest/60 backdrop-blur-xl rounded-[1.5rem] border border-white/10 shadow-2xl p-8 sm:p-10 relative overflow-hidden">
          ...
          <div className="mb-6 flex justify-center">
            <Link href="/" className="inline-flex items-center gap-2.5 group">
              <div className="bg-primary-fixed-dim/20 p-2.5 rounded-xl border border-primary-fixed-dim/30 group-hover:border-primary-fixed-dim/60 transition-colors">
                <BrainCircuit className="h-8 w-8 text-primary-fixed-dim" />
              </div>
              <div className="text-left">
                <span className="text-xl font-display font-black text-on-surface">UniSmart</span>
                <p className="text-[10px] text-primary-fixed-dim font-label font-bold tracking-widest uppercase">Admin Portal</p>
              </div>
            </Link>
          </div>
          ...
          <div className="text-center mb-8">
            <h1 className="font-display text-2xl font-bold tracking-tight text-on-surface mb-2">
              {step === 'email' ? 'Admin Portal' : 'Verification'}
            </h1>
            <p className="font-body text-xs text-on-surface-variant leading-relaxed">
              {step === 'email'
                ? 'Enter your registered admin email to receive a one-time passcode'
          ...
          {/* Dev Mode OTP Helper */}
          {devOtp && step === 'otp' && (
            <div className="bg-primary/10 border border-primary/20 rounded-xl px-4 py-3 mb-6 flex flex-col items-center gap-1.5">
              <p className="text-[10px] text-primary-fixed-dim font-bold tracking-wider uppercase">Development OTP Code</p>
          ...
          {step === 'email' ? (
            <form onSubmit={handleSendOtp} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-11 pr-4 py-3.5 bg-surface-variant/50 border border-outline-variant/50 rounded-xl text-on-surface placeholder-on-surface-variant/40 focus:ring-2 focus:ring-primary-fixed-dim/30 focus:border-primary-fixed-dim focus:outline-none transition-all duration-200"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center gap-2 py-3.5 px-4 border border-transparent rounded-full shadow-sm text-sm font-label font-semibold text-on-primary-fixed bg-primary-fixed-dim hover:bg-primary-fixed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-primary-fixed-dim transition-all duration-200 transform active:scale-[0.98] disabled:opacity-50"
              >
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="000000"
                    className="block w-full pl-11 pr-4 py-3.5 bg-surface-variant/50 border border-outline-variant/50 rounded-xl text-on-surface placeholder-on-surface-variant/40 font-mono tracking-[0.3em] text-center focus:ring-2 focus:ring-primary-fixed-dim/30 focus:border-primary-fixed-dim focus:outline-none transition-all duration-200"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <button
                  ...
                  disabled={cooldown > 0}
                  className="text-xs text-primary-fixed-dim hover:text-primary-fixed font-semibold disabled:text-on-surface-variant/40 transition-colors duration-200"
                >
